...
<html lang="en">
    ...
    <head>
        ...
        <!-- App Css-->
        <link href="{{asset('backend/assets/css/app.min.cs')}}s" id="app-style" rel="stylesheet" type="text/css" />
    ...
    <body class="auth-body-bg">
        ...
        <div class="wrapper-page">
            ...
            <form method="POST" class="form-horizontal mt-3" action="{{ route('register') }}">
                @csrf
                <div class="danger-error-message" style="background: rgb(254, 155, 155">
                <x-input-error :messages="$errors->get('name')" style="color: red" />
                <x-input-error :messages="$errors->get('username')" style="color: red" />
                <x-input-error :messages="$errors->get('email')" style="color: red" />
                <x-input-error :messages="$errors->get('password')" style="color: red" />
                <x-input-error :messages="$errors->get('password_confirmation')" style="color: red" />
                </div>
 ...
 <div class="form-group mb-3 row">
                    <div class="col-12">
                        <input id="email" class="form-control" type="text" name="username" placeholder="Username">
                    </div>
                </div>
