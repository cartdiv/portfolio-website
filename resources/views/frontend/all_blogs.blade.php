            ...
            <div class="row">
                    ...
                    <div class="standard__blog__post">
                        ...
                        <div class="standard__blog__content">
                            <div class="blog__post__avatar">
                                ...
                                <span class="post__by">By : <a href="#"></a></span>
                            </div>
                ...
                @endforeach
                    ...
                    <div class="pagination-wrap">
                       {{$listallbogs->links('vendor.pagination.custom')}}
                </div>
                    ...
                    <aside class="blog__sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__cat">
                                ...
                                <li class="sidebar__cat__item"><a href="{{route('category.post', $catr->id)}}">{{$catr->blog_category}}</a></li>
                               @endforeach
                            </ul>
                        </div>
                        <div class="widget">
