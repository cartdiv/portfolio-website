            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{$portfoilo->portfolio_title}}</h2>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services__details__thumb">
                        <img src="{{ asset($portfoilo->portfolio_image)}}" alt="">
                    </div>
                    <div class="services__details__content">
                        <h2 class="title">{{$portfoilo->portfolio_name}}</h2>
                        <p>{!! $portfoilo->portfolio_description !!}</p>
                        </div>
                </div>
                <div class="col-lg-4">
