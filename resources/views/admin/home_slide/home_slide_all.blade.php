                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action=" {{ route('update.slider') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input name="short_title" class="form-control" type="titel" value="{{ $homeslide->short_title }}" id="example-email-input">
                                                </div>
                                            </div>
                                            ...
                                            <input type="submit" class="btn btn-secondary waves-effect waves-light" value="update Slider">
                                        </form>
