                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{route('update.blog')}} " enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <label for="example-email-input" class="col-sm-2 col-form-label">Blog tags</label>
                                                <div class="col-sm-10">
                                            ...
                                            <input type="submit" class="btn btn-secondary waves-effect waves-light" value="Add Blog">
                                        </form>
